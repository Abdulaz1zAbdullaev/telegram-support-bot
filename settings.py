...
WELCOME_MESSAGE = os.getenv("WELCOME_MESSAGE", "Assalomu alaykum, operatorlarimiz siz bilan tez orada bog'lanishadi, iltimos chatni boshlash uchun ismingizni kiriting !")
